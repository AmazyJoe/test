...
class SearchHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search_history" do
    assert_difference("SearchHistory.count") do
      post search_histories_url, params: { search_history: { query: @search_history.query, user_id: @search_history.user_id } }
    end
  ...
  test "should update search_history" do
    patch search_history_url(@search_history), params: { search_history: { query: @search_history.query, user_id: @search_history.user_id } }
